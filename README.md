...
use (
    ...
    ./packages/espyna-golang/contrib/postgres
    ./packages/espyna-golang/contrib/google
    ./packages/espyna-golang/contrib/azure
    ./packages/espyna-golang/contrib/aws
    ./packages/espyna-golang/contrib/gin
    ./packages/espyna-golang/contrib/fiber
...
# Each contrib module
cd packages/espyna-golang/contrib/postgres && go build ./...
cd packages/espyna-golang/contrib/google && go build ./...
cd packages/espyna-golang/contrib/azure && go build ./...
cd packages/espyna-golang/contrib/aws && go build ./...
cd packages/espyna-golang/contrib/gin && go build ./...
