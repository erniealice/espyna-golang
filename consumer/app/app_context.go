...
type AppContext struct {
	...
	// ResolveSubscriptionGroupDocumentTemplate composes the report-scoped subscription-group
	...
	ResolveSubscriptionGroupDocumentTemplate any
	// StoreSubscriptionGroupDocumentTemplate and DeleteSubscriptionGroupDocumentTemplateObject are app-owned,
	// exact-locator storage capabilities used only by the
	// subscription_group_document_template settings lifecycle. They are not HTTP routes.
	StoreSubscriptionGroupDocumentTemplate        any
	DeleteSubscriptionGroupDocumentTemplateObject any
