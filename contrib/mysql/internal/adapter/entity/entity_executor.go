...
// Package entity holds MySQL entity adapter implementations.
package entity
...
// GetExecutor method, which returns interfaces.DBExecutor — the shared exported
// type that avoids the "missing method GetExecutor" panic caused by each
// package previously defining its own unexported dbExecutor copy.
