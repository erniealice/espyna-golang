...
func (r *MySQLPayrollRemittanceRepository) CountDueWithin(
	ctx context.Context,
	workspaceID string,
	days int,
) (int64, error) {
	...
	var n int64
	if err := r.db.QueryRowContext(ctx, query, now, until, workspaceID, workspaceID, workspaceID).Scan(&n); err != nil {
...
func (r *MySQLPayrollRemittanceRepository) UpcomingDeadlines(
	ctx context.Context,
	workspaceID string,
	limit int32,
