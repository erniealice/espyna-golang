...
func init() {
	registry.RegisterRepositoryFactory("mysql", entityid.RateTable, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("mysql rate_table repository requires *sql.DB, got %T", conn)
		}
		dbOps := mysqlCore.NewWorkspaceAwareOperations(db)
		return NewMySQLRateTableRepository(dbOps, tableName), nil
	})
}

// MySQLRateTableRepository implements rate table CRUD operations using MySQL 8.0+.
type MySQLRateTableRepository struct {
	ratetablepb.UnimplementedRateTableDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewMySQLRateTableRepository creates a new MySQL rate table repository.
func NewMySQLRateTableRepository(dbOps interfaces.DatabaseOperation, tableName string) ratetablepb.RateTableDomainServiceServer {
	if tableName == "" {
		tableName = "rate_table"
	}
	return &MySQLRateTableRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *MySQLRateTableRepository) CreateRateTable(ctx context.Context, req *ratetablepb.CreateRateTableRequest) (*ratetablepb.CreateRateTableResponse, error) {
	if req.Data == nil {
...
func (r *MySQLRateTableRepository) ReadRateTable(ctx context.Context, req *ratetablepb.ReadRateTableRequest) (*ratetablepb.ReadRateTableResponse, error) {
...
func (r *MySQLRateTableRepository) UpdateRateTable(ctx context.Context, req *ratetablepb.UpdateRateTableRequest) (*ratetablepb.UpdateRateTableResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("rate table ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
...
func (r *MySQLRateTableRepository) DeleteRateTable(ctx context.Context, req *ratetablepb.DeleteRateTableRequest) (*ratetablepb.DeleteRateTableResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("rate table ID is required")
	}
...
func (r *MySQLRateTableRepository) ListRateTables(ctx context.Context, req *ratetablepb.ListRateTablesRequest) (*ratetablepb.ListRateTablesResponse, error) {
...
func (r *MySQLRateTableRepository) GetRateTableListPageData(
	ctx context.Context,
...
func (r *MySQLRateTableRepository) GetRateTableItemPageData(
	ctx context.Context,
