...
// Package treasury — MySQL 8.0+ adapter for the
...
func init() {
	registry.RegisterRepositoryFactory("mysql", entityid.DisbursementSupplierBillingEvent, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("mysql disbursement_supplier_billing_event repository requires *sql.DB, got %T", conn)
		}
		dbOps := mysqlCore.NewWorkspaceAwareOperations(db)
		return NewMySQLDisbursementSupplierBillingEventRepository(dbOps, tableName), nil
	})
}

// MySQLDisbursementSupplierBillingEventRepository implements
// junction CRUD using MySQL 8.0+.
type MySQLDisbursementSupplierBillingEventRepository struct {
	pb.UnimplementedDisbursementSupplierBillingEventDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewMySQLDisbursementSupplierBillingEventRepository creates a new repository.
func NewMySQLDisbursementSupplierBillingEventRepository(dbOps interfaces.DatabaseOperation, tableName string) pb.DisbursementSupplierBillingEventDomainServiceServer {
	if tableName == "" {
		tableName = entityid.DisbursementSupplierBillingEvent
	}
	return &MySQLDisbursementSupplierBillingEventRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *MySQLDisbursementSupplierBillingEventRepository) CreateDisbursementSupplierBillingEvent(ctx context.Context, req *pb.CreateDisbursementSupplierBillingEventRequest) (*pb.CreateDisbursementSupplierBillingEventResponse, error) {
...
func (r *MySQLDisbursementSupplierBillingEventRepository) ReadDisbursementSupplierBillingEvent(ctx context.Context, req *pb.ReadDisbursementSupplierBillingEventRequest) (*pb.ReadDisbursementSupplierBillingEventResponse, error) {
...
func (r *MySQLDisbursementSupplierBillingEventRepository) UpdateDisbursementSupplierBillingEvent(ctx context.Context, req *pb.UpdateDisbursementSupplierBillingEventRequest) (*pb.UpdateDisbursementSupplierBillingEventResponse, error) {
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("disbursement_supplier_billing_event ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
...
func (r *MySQLDisbursementSupplierBillingEventRepository) DeleteDisbursementSupplierBillingEvent(ctx context.Context, req *pb.DeleteDisbursementSupplierBillingEventRequest) (*pb.DeleteDisbursementSupplierBillingEventResponse, error) {
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("disbursement_supplier_billing_event ID is required")
	}
...
func (r *MySQLDisbursementSupplierBillingEventRepository) ListDisbursementSupplierBillingEvents(ctx context.Context, req *pb.ListDisbursementSupplierBillingEventsRequest) (*pb.ListDisbursementSupplierBillingEventsResponse, error) {
