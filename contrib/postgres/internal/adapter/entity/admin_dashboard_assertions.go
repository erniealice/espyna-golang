...
// Compile-time assertions: every postgres admin-dashboard repo MUST satisfy
...
//
// The admin dashboard composition root performs runtime type assertions
...
// `entity.RolePermissionCount` instead of `admindash.RolePermissionCount`.
//
...
// (Location, Ledger, Equity, Treasury, Payroll, etc.). Each Wave B
// candidate MUST add equivalent assertions when its adapter lands.
var (
	_ admindash.PermissionDashboardRepository        = (*PostgresPermissionRepository)(nil)
	_ admindash.RoleDashboardRepository              = (*PostgresRoleRepository)(nil)
	_ admindash.WorkspaceUserDashboardRepository     = (*PostgresWorkspaceUserRepository)(nil)
	_ admindash.WorkspaceUserRoleDashboardRepository = (*PostgresWorkspaceUserRoleRepository)(nil)
)
