...
// Package treasury — postgres adapter for the collection_billing_event
// junction entity.
//
...
func init() {
	registry.RegisterRepositoryFactory("postgresql", entityid.CollectionBillingEvent, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("postgres collection_billing_event repository requires *sql.DB, got %T", conn)
		}
		dbOps := postgresCore.NewWorkspaceAwareOperations(db)
		return NewPostgresCollectionBillingEventRepository(dbOps, tableName), nil
	})
}

// PostgresCollectionBillingEventRepository implements junction CRUD using PostgreSQL.
type PostgresCollectionBillingEventRepository struct {
...
// NewPostgresCollectionBillingEventRepository creates a new repository.
func NewPostgresCollectionBillingEventRepository(dbOps interfaces.DatabaseOperation, tableName string) pb.CollectionBillingEventDomainServiceServer {
	if tableName == "" {
	...
	return &PostgresCollectionBillingEventRepository{
		dbOps:     dbOps,
		db:        db,
		tableName: tableName,
	}
...
func (r *PostgresCollectionBillingEventRepository) CreateCollectionBillingEvent(ctx context.Context, req *pb.CreateCollectionBillingEventRequest) (*pb.CreateCollectionBillingEventResponse, error) {
...
func (r *PostgresCollectionBillingEventRepository) ReadCollectionBillingEvent(ctx context.Context, req *pb.ReadCollectionBillingEventRequest) (*pb.ReadCollectionBillingEventResponse, error) {
...
func (r *PostgresCollectionBillingEventRepository) UpdateCollectionBillingEvent(ctx context.Context, req *pb.UpdateCollectionBillingEventRequest) (*pb.UpdateCollectionBillingEventResponse, error) {
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("collection_billing_event ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
...
func (r *PostgresCollectionBillingEventRepository) DeleteCollectionBillingEvent(ctx context.Context, req *pb.DeleteCollectionBillingEventRequest) (*pb.DeleteCollectionBillingEventResponse, error) {
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("collection_billing_event ID is required")
	}
...
func (r *PostgresCollectionBillingEventRepository) ListCollectionBillingEvents(ctx context.Context, req *pb.ListCollectionBillingEventsRequest) (*pb.ListCollectionBillingEventsResponse, error) {
