...
func init() {
	registry.RegisterRepositoryFactory("sqlserver", entityid.AssetRevaluation, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("sqlserver asset_revaluation repository requires *sql.DB, got %T", conn)
		}
		dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
		return NewSQLServerAssetRevaluationRepository(dbOps, tableName), nil
	})
}
...
// SQLServerAssetRevaluationRepository implements asset_revaluation CRUD operations
// using SQL Server. AssetRevaluation rows are append-only: no business flow
...
type SQLServerAssetRevaluationRepository struct {
	revaluationpb.UnimplementedAssetRevaluationDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewSQLServerAssetRevaluationRepository creates a new SQL Server asset_revaluation repository.
func NewSQLServerAssetRevaluationRepository(dbOps interfaces.DatabaseOperation, tableName string) revaluationpb.AssetRevaluationDomainServiceServer {
	if tableName == "" {
		tableName = "asset_revaluation"
	}
	return &SQLServerAssetRevaluationRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *SQLServerAssetRevaluationRepository) CreateAssetRevaluation(ctx context.Context, req *revaluationpb.CreateAssetRevaluationRequest) (*revaluationpb.CreateAssetRevaluationResponse, error) {
	if req.Data == nil {
...
func (r *SQLServerAssetRevaluationRepository) ReadAssetRevaluation(ctx context.Context, req *revaluationpb.ReadAssetRevaluationRequest) (*revaluationpb.ReadAssetRevaluationResponse, error) {
...
func (r *SQLServerAssetRevaluationRepository) UpdateAssetRevaluation(ctx context.Context, req *revaluationpb.UpdateAssetRevaluationRequest) (*revaluationpb.UpdateAssetRevaluationResponse, error) {
...
func (r *SQLServerAssetRevaluationRepository) DeleteAssetRevaluation(ctx context.Context, req *revaluationpb.DeleteAssetRevaluationRequest) (*revaluationpb.DeleteAssetRevaluationResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("asset_revaluation ID is required")
	}
...
// ListAssetRevaluations lists asset_revaluation rows using SQL Server operations.
func (r *SQLServerAssetRevaluationRepository) ListAssetRevaluations(ctx context.Context, req *revaluationpb.ListAssetRevaluationsRequest) (*revaluationpb.ListAssetRevaluationsResponse, error) {
...
func (r *SQLServerAssetRevaluationRepository) GetAssetRevaluationListPageData(
	ctx context.Context,
...
func (r *SQLServerAssetRevaluationRepository) GetAssetRevaluationItemPageData(
	ctx context.Context,
...
// NewAssetRevaluationRepository creates a new SQL Server asset_revaluation repository (old-style constructor).
func NewAssetRevaluationRepository(db *sql.DB, tableName string) revaluationpb.AssetRevaluationDomainServiceServer {
	dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
	return NewSQLServerAssetRevaluationRepository(dbOps, tableName)
}
