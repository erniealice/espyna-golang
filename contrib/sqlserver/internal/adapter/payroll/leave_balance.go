...
func init() {
	registry.RegisterRepositoryFactory("sqlserver", entityid.LeaveBalance, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("sqlserver leave_balance repository requires *sql.DB, got %T", conn)
		}
		dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
		return NewSQLServerLeaveBalanceRepository(dbOps, tableName), nil
	})
}

// SQLServerLeaveBalanceRepository implements leave balance CRUD operations using SQL Server.
type SQLServerLeaveBalanceRepository struct {
	leavebalancepb.UnimplementedLeaveBalanceDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewSQLServerLeaveBalanceRepository creates a new SQL Server leave balance repository.
func NewSQLServerLeaveBalanceRepository(dbOps interfaces.DatabaseOperation, tableName string) leavebalancepb.LeaveBalanceDomainServiceServer {
	if tableName == "" {
		tableName = "leave_balance"
	}
	return &SQLServerLeaveBalanceRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *SQLServerLeaveBalanceRepository) CreateLeaveBalance(ctx context.Context, req *leavebalancepb.CreateLeaveBalanceRequest) (*leavebalancepb.CreateLeaveBalanceResponse, error) {
	if req.Data == nil {
...
func (r *SQLServerLeaveBalanceRepository) ReadLeaveBalance(ctx context.Context, req *leavebalancepb.ReadLeaveBalanceRequest) (*leavebalancepb.ReadLeaveBalanceResponse, error) {
...
func (r *SQLServerLeaveBalanceRepository) UpdateLeaveBalance(ctx context.Context, req *leavebalancepb.UpdateLeaveBalanceRequest) (*leavebalancepb.UpdateLeaveBalanceResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("leave balance ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
...
func (r *SQLServerLeaveBalanceRepository) DeleteLeaveBalance(ctx context.Context, req *leavebalancepb.DeleteLeaveBalanceRequest) (*leavebalancepb.DeleteLeaveBalanceResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("leave balance ID is required")
	}
...
func (r *SQLServerLeaveBalanceRepository) ListLeaveBalances(ctx context.Context, req *leavebalancepb.ListLeaveBalancesRequest) (*leavebalancepb.ListLeaveBalancesResponse, error) {
...
func (r *SQLServerLeaveBalanceRepository) GetLeaveBalanceListPageData(
	ctx context.Context,
...
func (r *SQLServerLeaveBalanceRepository) GetLeaveBalanceItemPageData(
	ctx context.Context,
