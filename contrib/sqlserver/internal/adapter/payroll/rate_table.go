...
func init() {
	registry.RegisterRepositoryFactory("sqlserver", entityid.RateTable, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("sqlserver rate_table repository requires *sql.DB, got %T", conn)
		}
		dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
		return NewSQLServerRateTableRepository(dbOps, tableName), nil
	})
}

// SQLServerRateTableRepository implements rate table CRUD operations using SQL Server.
type SQLServerRateTableRepository struct {
	ratetablepb.UnimplementedRateTableDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewSQLServerRateTableRepository creates a new SQL Server rate table repository.
func NewSQLServerRateTableRepository(dbOps interfaces.DatabaseOperation, tableName string) ratetablepb.RateTableDomainServiceServer {
	if tableName == "" {
		tableName = "rate_table"
	}
	return &SQLServerRateTableRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *SQLServerRateTableRepository) CreateRateTable(ctx context.Context, req *ratetablepb.CreateRateTableRequest) (*ratetablepb.CreateRateTableResponse, error) {
	if req.Data == nil {
...
func (r *SQLServerRateTableRepository) ReadRateTable(ctx context.Context, req *ratetablepb.ReadRateTableRequest) (*ratetablepb.ReadRateTableResponse, error) {
...
func (r *SQLServerRateTableRepository) UpdateRateTable(ctx context.Context, req *ratetablepb.UpdateRateTableRequest) (*ratetablepb.UpdateRateTableResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("rate table ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
...
func (r *SQLServerRateTableRepository) DeleteRateTable(ctx context.Context, req *ratetablepb.DeleteRateTableRequest) (*ratetablepb.DeleteRateTableResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("rate table ID is required")
	}
...
func (r *SQLServerRateTableRepository) ListRateTables(ctx context.Context, req *ratetablepb.ListRateTablesRequest) (*ratetablepb.ListRateTablesResponse, error) {
...
func (r *SQLServerRateTableRepository) GetRateTableListPageData(
	ctx context.Context,
...
func (r *SQLServerRateTableRepository) GetRateTableItemPageData(
	ctx context.Context,
