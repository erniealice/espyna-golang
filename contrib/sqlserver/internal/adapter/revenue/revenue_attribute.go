...
func init() {
	registry.RegisterRepositoryFactory("sqlserver", entityid.RevenueAttribute, func(conn any, tableName string) (any, error) {
		db, ok := conn.(*sql.DB)
		if !ok {
			return nil, fmt.Errorf("sqlserver revenue_attribute repository requires *sql.DB, got %T", conn)
		}
		dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
		return NewSQLServerRevenueAttributeRepository(dbOps, tableName), nil
	})
}

// SQLServerRevenueAttributeRepository implements revenue_attribute CRUD using SQL Server.
type SQLServerRevenueAttributeRepository struct {
	revenueattributepb.UnimplementedRevenueAttributeDomainServiceServer
	dbOps     interfaces.DatabaseOperation
	tableName string
}

// NewSQLServerRevenueAttributeRepository creates a new SQL Server revenue attribute repository.
func NewSQLServerRevenueAttributeRepository(dbOps interfaces.DatabaseOperation, tableName string) revenueattributepb.RevenueAttributeDomainServiceServer {
	if tableName == "" {
		tableName = "revenue_attribute"
	}
	return &SQLServerRevenueAttributeRepository{
		dbOps:     dbOps,
		tableName: tableName,
	}
}
...
func (r *SQLServerRevenueAttributeRepository) CreateRevenueAttribute(ctx context.Context, req *revenueattributepb.CreateRevenueAttributeRequest) (*revenueattributepb.CreateRevenueAttributeResponse, error) {
	if req.Data == nil {
	...
	return &revenueattributepb.CreateRevenueAttributeResponse{Data: []*revenueattributepb.RevenueAttribute{attr}}, nil
}

// ReadRevenueAttribute retrieves a revenue attribute by ID.
func (r *SQLServerRevenueAttributeRepository) ReadRevenueAttribute(ctx context.Context, req *revenueattributepb.ReadRevenueAttributeRequest) (*revenueattributepb.ReadRevenueAttributeResponse, error) {
	...
	return &revenueattributepb.ReadRevenueAttributeResponse{Data: []*revenueattributepb.RevenueAttribute{attr}}, nil
}

// UpdateRevenueAttribute updates a revenue attribute.
func (r *SQLServerRevenueAttributeRepository) UpdateRevenueAttribute(ctx context.Context, req *revenueattributepb.UpdateRevenueAttributeRequest) (*revenueattributepb.UpdateRevenueAttributeResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("revenue attribute ID is required")
	}
	jsonData, err := protojson.Marshal(req.Data)
	...
	return &revenueattributepb.UpdateRevenueAttributeResponse{Data: []*revenueattributepb.RevenueAttribute{attr}}, nil
}

// DeleteRevenueAttribute soft-deletes a revenue attribute.
func (r *SQLServerRevenueAttributeRepository) DeleteRevenueAttribute(ctx context.Context, req *revenueattributepb.DeleteRevenueAttributeRequest) (*revenueattributepb.DeleteRevenueAttributeResponse, error) {
	if req.Data == nil || req.Data.Id == "" {
		return nil, fmt.Errorf("revenue attribute ID is required")
	}
...
func (r *SQLServerRevenueAttributeRepository) ListRevenueAttributes(ctx context.Context, req *revenueattributepb.ListRevenueAttributesRequest) (*revenueattributepb.ListRevenueAttributesResponse, error) {
...
// GetRevenueAttributeListPageData retrieves revenue attributes with pagination, sorting, and search.
//
...
//   - COUNT(*) OVER () retained.
func (r *SQLServerRevenueAttributeRepository) GetRevenueAttributeListPageData(
	ctx context.Context,
	...
	orderByClause, err := sqlserverCore.BuildOrderBy(
		revenueAttributeSortableSQLCols, req.GetSort(), "date_created DESC")
	if err != nil {
		return nil, err
	}
	...
	for rows.Next() {
		...
		if err := rows.Scan(&id, &revenueID, &attributeID, &value, &dateCreated, &dateModified, &active, &revenueName, &total); err != nil {
...
func (r *SQLServerRevenueAttributeRepository) GetRevenueAttributeItemPageData(
	ctx context.Context,
	...
	exec := r.dbOps.(executorProvider).GetExecutor(ctx)
	row := exec.QueryRowContext(ctx, query, req.RevenueAttributeId)
	...
	if err := row.Scan(&id, &revenueID, &attributeID, &value, &dateCreated, &dateModified, &active, &revenueName); err != nil {
...
// NewRevenueAttributeRepository creates a new SQL Server revenue attribute repository (old-style constructor).
func NewRevenueAttributeRepository(db *sql.DB, tableName string) revenueattributepb.RevenueAttributeDomainServiceServer {
	dbOps := sqlserverCore.NewWorkspaceAwareOperations(db)
	return NewSQLServerRevenueAttributeRepository(dbOps, tableName)
}
