...
const (
	...
	// Operation Domain (13 entities)
	EntityJobTemplate       = "job_template"
	EntityJobTemplatePhase  = "job_template_phase"
	EntityJobTemplateTask   = "job_template_task"
	EntityJob               = "job"
	EntityJobPhase          = "job_phase"
	EntityJobTask           = "job_task"
	EntityJobActivity       = "job_activity"
	EntityActivityLabor     = "activity_labor"
	EntityActivityMaterial  = "activity_material"
