...
func (uc *UpdateCriteriaOptionUseCase) executeCore(ctx context.Context, req *pb.UpdateCriteriaOptionRequest, enrichedData *pb.CriteriaOption) (*pb.UpdateCriteriaOptionResponse, error) {
	...
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "criteria_option.errors.update_failed", "[ERR-DEFAULT] Criteria option update failed"))
	}
	return resp, nil
}
