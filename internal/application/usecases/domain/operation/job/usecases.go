...
func (uc *CreateJobUseCase) Execute(ctx context.Context, req *pb.CreateJobRequest) (*pb.CreateJobResponse, error) {
	if err := uc.services.ActionGatekeeper.Check(ctx, &actiongate.CheckActionRequest{Entity: "job", Action: entityid.ActionCreate}); err != nil {
		return nil, err
	}
	if req == nil || req.Data == nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.data_required", "job data is required [DEFAULT]"))
	}
	if strings.TrimSpace(req.Data.Name) == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.name_required", "job name is required [DEFAULT]"))
	}
...
func (uc *ReadJobUseCase) Execute(ctx context.Context, req *pb.ReadJobRequest) (*pb.ReadJobResponse, error) {
	if err := uc.services.ActionGatekeeper.Check(ctx, &actiongate.CheckActionRequest{Entity: "job", Action: entityid.ActionRead}); err != nil {
		return nil, err
	}
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.id_required", "job ID is required"))
	}
	result, err := uc.repositories.Job.ReadJob(ctx, req)
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.errors.not_found", "job not found [DEFAULT]"))
	}
	return result, nil
}
...
func (uc *UpdateJobUseCase) Execute(ctx context.Context, req *pb.UpdateJobRequest) (*pb.UpdateJobResponse, error) {
	if err := uc.services.ActionGatekeeper.Check(ctx, &actiongate.CheckActionRequest{Entity: "job", Action: entityid.ActionUpdate}); err != nil {
		return nil, err
	}
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.id_required", "job ID is required"))
	...
	if strings.TrimSpace(req.Data.Name) == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.name_required", "job name is required"))
	}
	now := time.Now()
	dm := now.UnixMilli()
	...
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.errors.update_failed", "job update failed [DEFAULT]"))
	}
...
func (uc *DeleteJobUseCase) Execute(ctx context.Context, req *pb.DeleteJobRequest) (*pb.DeleteJobResponse, error) {
	if err := uc.services.ActionGatekeeper.Check(ctx, &actiongate.CheckActionRequest{Entity: "job", Action: entityid.ActionDelete}); err != nil {
		return nil, err
	}
	if req == nil || req.Data == nil || req.Data.Id == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.id_required", "job ID is required"))
	...
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.errors.deletion_failed", "job deletion failed [DEFAULT]"))
	}
	return result, nil
}
...
func (uc *ListJobsUseCase) Execute(ctx context.Context, req *pb.ListJobsRequest) (*pb.ListJobsResponse, error) {
	if err := uc.services.ActionGatekeeper.Check(ctx, &actiongate.CheckActionRequest{Entity: "job", Action: entityid.ActionList}); err != nil {
		return nil, err
	}
	if req == nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.request_required", "request is required"))
	}
	result, err := uc.repositories.Job.ListJobs(ctx, req)
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.errors.list_failed", "job listing failed [DEFAULT]"))
	}
	return result, nil
}
...
func (uc *GetJobsByClientUseCase) Execute(ctx context.Context, req *pb.GetJobsByClientRequest) (*pb.GetJobsByClientResponse, error) {
	...
	if req == nil || req.ClientId == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.client_id_required", "client ID is required"))
	}
...
func (uc *GetJobsByOriginUseCase) Execute(ctx context.Context, req *pb.GetJobsByOriginRequest) (*pb.GetJobsByOriginResponse, error) {
	...
	if req == nil || req.OriginId == "" {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.origin_id_required", "origin ID is required"))
	}
...
func (uc *UpdateJobStatusUseCase) Execute(ctx context.Context, req *pb.UpdateJobStatusRequest) (*pb.UpdateJobStatusResponse, error) {
	...
	if req.Status == enumspb.JobStatus_JOB_STATUS_UNSPECIFIED {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.validation.status_required", "target status is required"))
	}
	...
	if err != nil || currentJob == nil || len(currentJob.Data) == 0 {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "job.errors.not_found", "job not found"))
	}
	...
	if !ok {
		return nil, fmt.Errorf(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator,
