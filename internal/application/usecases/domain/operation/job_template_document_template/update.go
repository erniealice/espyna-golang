...
func (uc *UpdateUseCase) Execute(ctx context.Context, req *pb.UpdateJobTemplateDocumentTemplateRequest) (*pb.UpdateJobTemplateDocumentTemplateResponse, error) {
	...
	return uc.repo.UpdateJobTemplateDocumentTemplate(ctx, req)
}
