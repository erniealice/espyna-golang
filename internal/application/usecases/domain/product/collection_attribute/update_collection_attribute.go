...
func (uc *UpdateCollectionAttributeUseCase) Execute(ctx context.Context, req *collectionattributepb.UpdateCollectionAttributeRequest) (*collectionattributepb.UpdateCollectionAttributeResponse, error) {
	...
	if err := authcheck.Check(ctx, uc.services.Authorizer, uc.services.Translator,
		entityid.CollectionAttribute, entityid.ActionUpdate); err != nil {
		return nil, err
	}
...
func (uc *UpdateCollectionAttributeUseCase) executeCore(ctx context.Context, req *collectionattributepb.UpdateCollectionAttributeRequest) (*collectionattributepb.UpdateCollectionAttributeResponse, error) {
	...
	permission := entityid.EntityPermission(entityid.CollectionAttribute, entityid.ActionUpdate)
...
func (uc *UpdateCollectionAttributeUseCase) validateInput(ctx context.Context, req *collectionattributepb.UpdateCollectionAttributeRequest) error {
	...
	if req.Data.Id == "" {
		return errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "collection_attribute.validation.id_required", "Course attribute ID is required"))
	}
...
func (uc *UpdateCollectionAttributeUseCase) validateBusinessRules(ctx context.Context, productAttribute *collectionattributepb.CollectionAttribute) error {
	...
	if productAttribute.CollectionId == "" {
		return errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "collection_attribute.validation.product_association_required", "Collection attribute must be associated with a product [DEFAULT]"))
	}
...
func (uc *UpdateCollectionAttributeUseCase) validateEntityReferences(ctx context.Context, productAttribute *collectionattributepb.CollectionAttribute) error {
	...
	if productAttribute.CollectionId != "" {
		...
		if product == nil || product.Data == nil || len(product.Data) == 0 {
			translatedError := contextutil.GetTranslatedMessageWithContextAndTags(ctx, uc.services.Translator, "collection_attribute.errors.product_not_found", map[string]interface{}{"productId": productAttribute.CollectionId}, "Referenced product not found")
			return errors.New(translatedError)
		}
		if !product.Data[0].Active {
			translatedError := contextutil.GetTranslatedMessageWithContextAndTags(ctx, uc.services.Translator, "collection_attribute.errors.product_not_active", map[string]interface{}{"productId": productAttribute.CollectionId}, "Referenced product not active")
			return errors.New(translatedError)
		}
	}
	...
	if productAttribute.AttributeId != "" {
		...
		if attribute == nil || attribute.Data == nil || len(attribute.Data) == 0 {
			translatedError := contextutil.GetTranslatedMessageWithContextAndTags(ctx, uc.services.Translator, "collection_attribute.errors.attribute_not_found", map[string]interface{}{"attributeId": productAttribute.AttributeId}, "Referenced attribute not found")
			return errors.New(translatedError)
		}
		if !attribute.Data[0].Active {
			translatedError := contextutil.GetTranslatedMessageWithContextAndTags(ctx, uc.services.Translator, "collection_attribute.errors.attribute_not_active", map[string]interface{}{"attributeId": productAttribute.AttributeId}, "Referenced attribute not active")
			return errors.New(translatedError)
		}
	}
