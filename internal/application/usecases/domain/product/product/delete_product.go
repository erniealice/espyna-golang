...
func (uc *DeleteProductUseCase) Execute(ctx context.Context, req *productpb.DeleteProductRequest) (*productpb.DeleteProductResponse, error) {
	...
	if err := authcheck.Check(ctx, uc.services.Authorizer, uc.services.Translator,
		entityid.Product, entityid.ActionDelete); err != nil {
		return nil, err
	}
...
func (uc *DeleteProductUseCase) executeWithTransaction(ctx context.Context, req *productpb.DeleteProductRequest) (*productpb.DeleteProductResponse, error) {
	...
	if err != nil {
		translatedError := contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product.errors.transaction_failed", "Transaction execution failed [DEFAULT]")
...
func (uc *DeleteProductUseCase) executeCore(ctx context.Context, req *productpb.DeleteProductRequest) (*productpb.DeleteProductResponse, error) {
	...
	permission := entityid.EntityPermission(entityid.Product, entityid.ActionDelete)
	...
	if err != nil {
		translatedError := contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product.errors.deletion_failed", "Product deletion failed [DEFAULT]")
		return nil, fmt.Errorf("%s: %w", translatedError, err)
	}
	return resp, nil
}
...
func (uc *DeleteProductUseCase) validateBusinessRules(ctx context.Context, req *productpb.DeleteProductRequest) error {
	...
	if uc.isProductInUse(ctx, req.Data.Id) {
		return errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product.errors.in_use", "Product is currently in use and cannot be deleted [DEFAULT]"))
	}
	return nil
}
