...
func (uc *DeleteProductAttributeUseCase) Execute(ctx context.Context, req *productattributepb.DeleteProductAttributeRequest) (*productattributepb.DeleteProductAttributeResponse, error) {
	...
	if err := authcheck.Check(ctx, uc.services.Authorizer, uc.services.Translator,
		entityid.ProductAttribute, entityid.ActionDelete); err != nil {
		return nil, err
	}
...
func (uc *DeleteProductAttributeUseCase) executeWithTransaction(ctx context.Context, req *productattributepb.DeleteProductAttributeRequest) (*productattributepb.DeleteProductAttributeResponse, error) {
	...
	if err != nil {
		translatedError := contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product_attribute.errors.transaction_failed", "Transaction execution failed [DEFAULT]")
...
func (uc *DeleteProductAttributeUseCase) executeCore(ctx context.Context, req *productattributepb.DeleteProductAttributeRequest) (*productattributepb.DeleteProductAttributeResponse, error) {
	...
	permission := entityid.EntityPermission(entityid.ProductAttribute, entityid.ActionDelete)
	...
	if err := uc.validateBusinessRules(ctx, req); err != nil {
		translatedError := contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product_attribute.errors.business_rule_validation_failed", "Business rule validation failed [DEFAULT]")
		return nil, fmt.Errorf("%s: %w", translatedError, err)
	}
	...
	if err != nil {
		translatedError := contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product_attribute.errors.deletion_failed", "Product attribute deletion failed [DEFAULT]")
		return nil, fmt.Errorf("%s: %w", translatedError, err)
	}
	return resp, nil
}
...
func (uc *DeleteProductAttributeUseCase) validateInput(ctx context.Context, req *productattributepb.DeleteProductAttributeRequest) error {
	...
	if req.Data.Id == "" {
		return errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product_attribute.validation.id_required", "Product attribute ID is required [DEFAULT]"))
	}
	return nil
}
...
func (uc *DeleteProductAttributeUseCase) validateBusinessRules(ctx context.Context, req *productattributepb.DeleteProductAttributeRequest) error {
	...
	if uc.isProductAttributeInUse(ctx, req.Data.ProductId, req.Data.AttributeId) {
		return errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.Translator, "product_attribute.errors.in_use", "Product attribute is currently in use and cannot be deleted [DEFAULT]"))
	}
	return nil
}
