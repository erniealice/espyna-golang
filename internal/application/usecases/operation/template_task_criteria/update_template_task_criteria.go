...
func (uc *UpdateTemplateTaskCriteriaUseCase) executeCore(ctx context.Context, req *pb.UpdateTemplateTaskCriteriaRequest, enrichedData *pb.TemplateTaskCriteria) (*pb.UpdateTemplateTaskCriteriaResponse, error) {
	...
	if err != nil {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(ctx, uc.services.TranslationService, "template_task_criteria.errors.update_failed", "[ERR-DEFAULT] Template task criteria update failed"))
	}
	return resp, nil
}
