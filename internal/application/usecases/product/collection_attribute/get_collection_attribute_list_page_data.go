...
type GetCollectionAttributeListPageDataRepositories struct {
	CollectionAttribute collectionattributepb.CollectionAttributeDomainServiceServer
}

type GetCollectionAttributeListPageDataServices struct {
	TransactionService ports.TransactionService
	TranslationService ports.TranslationService
}

// GetCollectionAttributeListPageDataUseCase handles the business logic for getting product attribute list page data
type GetCollectionAttributeListPageDataUseCase struct {
	repositories GetCollectionAttributeListPageDataRepositories
	services     GetCollectionAttributeListPageDataServices
	processor    *listdata.ListDataProcessor
}

// NewGetCollectionAttributeListPageDataUseCase creates a new GetCollectionAttributeListPageDataUseCase
func NewGetCollectionAttributeListPageDataUseCase(
	repositories GetCollectionAttributeListPageDataRepositories,
	services GetCollectionAttributeListPageDataServices,
) *GetCollectionAttributeListPageDataUseCase {
	return &GetCollectionAttributeListPageDataUseCase{
...
func (uc *GetCollectionAttributeListPageDataUseCase) Execute(
	ctx context.Context,
...
func (uc *GetCollectionAttributeListPageDataUseCase) executeWithTransaction(
	ctx context.Context,
	req *collectionattributepb.GetCollectionAttributeListPageDataRequest,
) (*collectionattributepb.GetCollectionAttributeListPageDataResponse, error) {
	var result *collectionattributepb.GetCollectionAttributeListPageDataResponse
	...
	err := uc.services.TransactionService.ExecuteInTransaction(ctx, func(txCtx context.Context) error {
		...
		if err != nil {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				...
				"collection_attribute.errors.list_page_data_failed",
...
func (uc *GetCollectionAttributeListPageDataUseCase) executeCore(
	ctx context.Context,
	req *collectionattributepb.GetCollectionAttributeListPageDataRequest,
) (*collectionattributepb.GetCollectionAttributeListPageDataResponse, error) {
	// First, get all product attributes from the repository
	listReq := &collectionattributepb.ListCollectionAttributesRequest{}
	listResp, err := uc.repositories.CollectionAttribute.ListCollectionAttributes(ctx, listReq)
	if err != nil {
		return nil, fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.errors.list_failed",
	...
	if listResp == nil || len(listResp.Data) == 0 {
		...
		return &collectionattributepb.GetCollectionAttributeListPageDataResponse{
			CollectionAttributeList: []*collectionattributepb.CollectionAttribute{},
	...
	if err != nil {
		return nil, fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.errors.processing_failed",
			"failed to process product attribute list data: %w",
		), err)
	}

	// Convert processed items back to product attribute protobuf format
	productAttributes := make([]*collectionattributepb.CollectionAttribute, len(result.Items))
	for i, item := range result.Items {
		if productAttribute, ok := item.(*collectionattributepb.CollectionAttribute); ok {
			productAttributes[i] = productAttribute
		} else {
			return nil, errors.New(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.errors.type_conversion_failed",
	...
	return &collectionattributepb.GetCollectionAttributeListPageDataResponse{
		CollectionAttributeList: productAttributes,
...
func (uc *GetCollectionAttributeListPageDataUseCase) validateInput(
	ctx context.Context,
	req *collectionattributepb.GetCollectionAttributeListPageDataRequest,
) error {
	if req == nil {
...
func (uc *GetCollectionAttributeListPageDataUseCase) validatePagination(
	ctx context.Context,
	...
	if pagination.Limit < 0 || pagination.Limit > 100 {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.validation.invalid_limit",
	...
	case *commonpb.PaginationRequest_Offset:
		if method.Offset.Page < 1 {
			return errors.New(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.invalid_page",
	...
	case *commonpb.PaginationRequest_Cursor:
		...
		if method.Cursor.Token == "" {
			return errors.New(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.invalid_cursor",
...
func (uc *GetCollectionAttributeListPageDataUseCase) validateFilters(
	ctx context.Context,
	...
	if len(filters.Filters) == 0 {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.validation.empty_filters",
	...
	for i, filter := range filters.Filters {
		if filter.Field == "" {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.filter_field_required",
				"filter field is required for filter %d",
			), i)
		}

		// Validate that the field exists on the product attribute entity
		if !uc.isValidCollectionAttributeField(filter.Field) {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.invalid_filter_field",
...
func (uc *GetCollectionAttributeListPageDataUseCase) validateSort(
	ctx context.Context,
	...
	if len(sort.Fields) == 0 {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.validation.empty_sort_fields",
	...
	for i, sortField := range sort.Fields {
		if sortField.Field == "" {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.sort_field_required",
				"sort field is required for sort field %d",
			), i)
		}

		// Validate that the field exists on the product attribute entity
		if !uc.isValidCollectionAttributeField(sortField.Field) {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.invalid_sort_field",
...
func (uc *GetCollectionAttributeListPageDataUseCase) validateSearch(
	ctx context.Context,
	...
	if search.Query == "" {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"collection_attribute.validation.empty_search_query",
	...
	if search.Options != nil {
		...
		for _, field := range search.Options.SearchFields {
			if !uc.isValidCollectionAttributeField(field) {
				return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
					ctx,
					uc.services.TranslationService,
					"collection_attribute.validation.invalid_search_field",
		...
		if search.Options.MaxResults < 0 || search.Options.MaxResults > 1000 {
			return errors.New(contextutil.GetTranslatedMessageWithContext(
				ctx,
				uc.services.TranslationService,
				"collection_attribute.validation.invalid_max_results",
...
// isValidCollectionAttributeField checks if a field name is valid for product attribute filtering/sorting/searching
func (uc *GetCollectionAttributeListPageDataUseCase) isValidCollectionAttributeField(field string) bool {
