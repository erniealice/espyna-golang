...
type GetProductAttributeItemPageDataRepositories struct {
...
type GetProductAttributeItemPageDataUseCase struct {
	repositories GetProductAttributeItemPageDataRepositories
	services     GetProductAttributeItemPageDataServices
}

// NewGetProductAttributeItemPageDataUseCase creates a new GetProductAttributeItemPageDataUseCase
func NewGetProductAttributeItemPageDataUseCase(
	repositories GetProductAttributeItemPageDataRepositories,
	services GetProductAttributeItemPageDataServices,
) *GetProductAttributeItemPageDataUseCase {
	return &GetProductAttributeItemPageDataUseCase{
...
func (uc *GetProductAttributeItemPageDataUseCase) Execute(
	ctx context.Context,
	...
	if err := uc.validateBusinessRules(ctx, req.ProductAttributeId); err != nil {
		return nil, err
	}
...
func (uc *GetProductAttributeItemPageDataUseCase) executeWithTransaction(
	ctx context.Context,
	req *productattributepb.GetProductAttributeItemPageDataRequest,
) (*productattributepb.GetProductAttributeItemPageDataResponse, error) {
	var result *productattributepb.GetProductAttributeItemPageDataResponse
	...
	err := uc.services.TransactionService.ExecuteInTransaction(ctx, func(txCtx context.Context) error {
		...
		if err != nil {
			return fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
				...
				"product_attribute.errors.item_page_data_failed",
...
func (uc *GetProductAttributeItemPageDataUseCase) executeCore(
	ctx context.Context,
	req *productattributepb.GetProductAttributeItemPageDataRequest,
) (*productattributepb.GetProductAttributeItemPageDataResponse, error) {
	// Create read request for the product attribute
	readReq := &productattributepb.ReadProductAttributeRequest{
		Data: &productattributepb.ProductAttribute{
			Id: req.ProductAttributeId,
		},
	}

	// Retrieve the product attribute
	readResp, err := uc.repositories.ProductAttribute.ReadProductAttribute(ctx, readReq)
	if err != nil {
		return nil, fmt.Errorf(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"product_attribute.errors.read_failed",
	...
	if readResp == nil || len(readResp.Data) == 0 {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"product_attribute.errors.not_found",
	...
	if productAttribute.Id != req.ProductAttributeId {
		return nil, errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"product_attribute.errors.id_mismatch",
...
func (uc *GetProductAttributeItemPageDataUseCase) validateInput(
	ctx context.Context,
	req *productattributepb.GetProductAttributeItemPageDataRequest,
) error {
	if req == nil {
	...
	if req.ProductAttributeId == "" {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"product_attribute.validation.id_required",
...
func (uc *GetProductAttributeItemPageDataUseCase) validateBusinessRules(
	ctx context.Context,
	...
	if len(productAttributeId) < 3 {
		return errors.New(contextutil.GetTranslatedMessageWithContext(
			ctx,
			uc.services.TranslationService,
			"product_attribute.validation.id_too_short",
...
func (uc *GetProductAttributeItemPageDataUseCase) loadRelatedData(
	ctx context.Context,
	...
	// if productAttribute.Product == nil && productAttribute.ProductId != "" {
	//     // Load product data
	// }
...
func (uc *GetProductAttributeItemPageDataUseCase) applyDataTransformation(
	ctx context.Context,
	productAttribute *productattributepb.ProductAttribute,
) *productattributepb.ProductAttribute {
...
func (uc *GetProductAttributeItemPageDataUseCase) checkAccessPermissions(
	ctx context.Context,
	productAttributeId string,
) error {
