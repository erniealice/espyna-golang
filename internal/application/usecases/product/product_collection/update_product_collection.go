...
// UpdateProductCollectionRepositories groups all repository dependencies
type UpdateProductCollectionRepositories struct {
...
// UpdateProductCollectionServices groups all business service dependencies
type UpdateProductCollectionServices struct {
...
// UpdateProductCollectionUseCase handles the business logic for updating product collections
type UpdateProductCollectionUseCase struct {
	repositories UpdateProductCollectionRepositories
	services     UpdateProductCollectionServices
}

// NewUpdateProductCollectionUseCase creates a new UpdateProductCollectionUseCase
func NewUpdateProductCollectionUseCase(
	repositories UpdateProductCollectionRepositories,
	services UpdateProductCollectionServices,
) *UpdateProductCollectionUseCase {
	return &UpdateProductCollectionUseCase{
		repositories: repositories,
		services:     services,
	}
}

// Execute performs the update product collection operation
func (uc *UpdateProductCollectionUseCase) Execute(ctx context.Context, req *productcollectionpb.UpdateProductCollectionRequest) (*productcollectionpb.UpdateProductCollectionResponse, error) {
	// Authorization check
	if err := authcheck.Check(ctx, uc.services.AuthorizationService, uc.services.TranslationService,
		ports.EntityProductCollection, ports.ActionUpdate); err != nil {
		return nil, err
	}
...
// executeWithTransaction executes product collection update within a transaction
func (uc *UpdateProductCollectionUseCase) executeWithTransaction(ctx context.Context, req *productcollectionpb.UpdateProductCollectionRequest) (*productcollectionpb.UpdateProductCollectionResponse, error) {
	var result *productcollectionpb.UpdateProductCollectionResponse

	err := uc.services.TransactionService.ExecuteInTransaction(ctx, func(txCtx context.Context) error {
		res, err := uc.executeCore(txCtx, req)
		if err != nil {
			translatedError := contextutil.GetTranslatedMessageWithContext(txCtx, uc.services.TranslationService, "product_collection.errors.update_failed", "Product collection update failed [DEFAULT]")
...
func (uc *UpdateProductCollectionUseCase) executeCore(ctx context.Context, req *productcollectionpb.UpdateProductCollectionRequest) (*productcollectionpb.UpdateProductCollectionResponse, error) {
	// Authorization check
	...
	permission := ports.EntityPermission(ports.EntityProductCollection, ports.ActionUpdate)
	...
	// Call repository
	resp, err := uc.repositories.ProductCollection.UpdateProductCollection(ctx, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (uc *UpdateProductCollectionUseCase) validateInput(ctx context.Context, req *productcollectionpb.UpdateProductCollectionRequest) error {
	if req == nil {
	...
	// ProductCollection uses ProductId and CollectionId for identification
...
func (uc *UpdateProductCollectionUseCase) enrichProductCollectionData(productCollection *productcollectionpb.ProductCollection) error {
	now := time.Now()
...
func (uc *UpdateProductCollectionUseCase) validateBusinessRules(ctx context.Context, productCollection *productcollectionpb.ProductCollection) error {
...
func (uc *UpdateProductCollectionUseCase) validateEntityReferences(ctx context.Context, productCollection *productcollectionpb.ProductCollection) error {
