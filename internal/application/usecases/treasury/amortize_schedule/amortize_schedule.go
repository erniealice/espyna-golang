// Package amortizeschedule holds the pure-function tranche enumerator used by
// both AmortizeAdvanceCollection (selling) and AmortizeAdvanceDisbursement
// (buying). The math lives here so the two use cases stay symmetrical and so
// the schedule can be unit-tested without any I/O.
//
// See docs/plan/20260517-advance-cash-events/plan.md §"Shared amortize_schedule helper".
