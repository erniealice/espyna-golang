...
func NewRecognizeMilestoneAdvanceCollectionUseCase(
	...
	return &RecognizeMilestoneAdvanceCollectionUseCase{repositories: repos, services: svcs}
}
...
func (uc *RecognizeMilestoneAdvanceCollectionUseCase) executeCore(
	...
	if _, err := uc.repositories.TreasuryCollection.UpdateCollection(ctx, &collectionpb.UpdateCollectionRequest{
		Data: adv,
	}); err != nil {
		return milestoneErrored(err), err
	}
