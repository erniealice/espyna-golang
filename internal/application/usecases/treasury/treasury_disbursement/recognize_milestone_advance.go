...
import (
	...
	junctionpb "github.com/erniealice/esqyma/pkg/schema/v1/domain/treasury/treasury_disbursement_supplier_billing_event"
)
...
func NewRecognizeMilestoneAdvanceDisbursementUseCase(
	...
	return &RecognizeMilestoneAdvanceDisbursementUseCase{repositories: repos, services: svcs}
}
...
func (uc *RecognizeMilestoneAdvanceDisbursementUseCase) executeCore(
	...
	if _, err := uc.repositories.TreasuryDisbursement.UpdateDisbursement(ctx, &disbursementpb.UpdateDisbursementRequest{
		Data: adv,
	}); err != nil {
		return milestoneErrored(err), err
	}
