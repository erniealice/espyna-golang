...
func TestComputeStraightLine_Normal(t *testing.T) {
	asset := depreciation.AssetParams{
	...
	got, err := depreciation.ComputeStraightLine(asset, period)
	if err != nil {
...
func TestComputeStraightLine_ZeroUsefulLife(t *testing.T) {
	...
	period := testPeriod(2025, 1, 1)
	_, err := depreciation.ComputeStraightLine(asset, period)
	if err == nil {
...
func TestComputeDecliningBalance_Normal(t *testing.T) {
	...
	period := testPeriod(2025, 1, 1)
	got, err := depreciation.ComputeDecliningBalance(asset, period, 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeDecliningBalance_SalvageFloor(t *testing.T) {
	...
	period := testPeriod(2030, 1, 60)
	got, err := depreciation.ComputeDecliningBalance(asset, period, 4_500_000)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 0 {
...
func TestComputeDecliningBalance_PartialPeriod(t *testing.T) {
	...
	got, err := depreciation.ComputeDecliningBalance(asset, testPeriod(2025, 1, 1), 890_000)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeDoubleDecliningBalance_Normal(t *testing.T) {
	...
	got, err := depreciation.ComputeDoubleDecliningBalance(asset, testPeriod(2025, 1, 1), 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeSumOfYearsDigits_Period1(t *testing.T) {
	...
	period := depreciation.PeriodParams{PeriodIndex: 1}
	got, err := depreciation.ComputeSumOfYearsDigits(asset, period)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeSumOfYearsDigits_LastPeriod(t *testing.T) {
	...
	period := depreciation.PeriodParams{PeriodIndex: 60}
	got, err := depreciation.ComputeSumOfYearsDigits(asset, period)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeSumOfYearsDigits_SalvageFloor(t *testing.T) {
	...
	period := depreciation.PeriodParams{PeriodIndex: 61}
	got, err := depreciation.ComputeSumOfYearsDigits(asset, period)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestComputeUnitsOfProduction_ReturnsError(t *testing.T) {
	...
	_, err := depreciation.ComputeUnitsOfProduction(asset, period, 0)
	if err == nil {
		t.Error("expected ErrUnitsRequired, got nil")
	}
	if err != depreciation.ErrUnitsRequired {
...
func TestComputeUnitsOfProduction_PositiveUnitsStillBlocked(t *testing.T) {
	...
	_, err := depreciation.ComputeUnitsOfProduction(asset, period, 100)
	if err != depreciation.ErrUnitsRequired {
...
func TestMidPeriodFraction_StartOnBoundary(t *testing.T) {
	period := testPeriod(2025, 1, 1)
	frac := depreciation.MidPeriodFraction(period.PeriodStart, period)
	if frac != 1.0 {
...
func TestDepreciableBase_NegativeClampedToZero(t *testing.T) {
	...
	got := depreciation.DepreciableBase(100_000, 200_000)
	if got != 0 {
