...
// pair. The bindingKind / bindingID / actingAs* hints (added 2026-05-24
// for A2 / WKR-P0-2 and extended for A2-followup / A2-P0-1) are
// currently ignored by the mock — tests that need to assert
